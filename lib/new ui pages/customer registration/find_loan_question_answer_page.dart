...
class _FindLoanQuestionAnswerState extends State<FindLoanQuestionAnswer> {
  List<int> rec_month_se__from_com = [1, 1];
  List<int> rec_month_se__from_busines = [1, 2];
  List<int> rec_month_se__from_com_as_doc = [1, 3, 0];
  List<int> rec_month_se__from_com_as_ca = [1, 3, 1];
  List<int> rec_month_se__from_com_as_cs = [1, 3, 2];
  List<int> rec_month_se__from_com_as_ea = [1, 3, 3];
  List<int> rec_month_se__from_com_as_free = [1, 3, 4];
  List<int> rec_month_se__from_com_as_other = [1, 3, 5];

  List<int> own_busines_for_bus_mort = [2, 1, 1];
  List<int> own_busines_for_bus_not_mort = [2, 1, 2];
  List<int> own_busines_cust_fot_them = [2, 2];
  List<int> own_businesas_doc = [2, 3, 0];
  List<int> own_businesas_ca = [2, 3, 1];
  List<int> own_businesas_cs = [2, 3, 2];
  List<int> own_businesas_ea = [2, 3, 3];
  List<int> own_businesas_free = [2, 3, 4];
  List<int> own_businesas_other = [2, 3, 5];

  List<int> as_doc = [3, 0];
  List<int> as_ca = [3, 1];
  List<int> as_cs = [3, 2];
  List<int> as_ea = [3, 3];
  List<int> as_free = [3, 4];
  List<int> as_other = [3, 5];

  List<int> list_click_index;
  ...
  String _var1 = "What is the employment type of your customer ?";
  ...
  List<String> employment_type = [
    ...
    'Owns a Business ',
    'Professional / Consultant / Private Practitioner / Freelancer'
  ];
...
//////////////////////////////////////////////////////////////////////
  ...
  void onClickAction(int pos) {
    ...
    if (_step_counter == 2) {
      ...
      setState(() {
        ...
        _var2 = _var1;
        _var1 = employment_type[pos];
        _var3 = "What is the employment type of your customer ?";
  ...
  bool checkArray() {
    if (list_click_index == rec_month_se__from_com) {
      _isVisible_step_all = false;
      _isVisible_final = true;
      return true;
    } else if (list_click_index == rec_month_se__from_busines) {
      _isVisible_step_all = false;
      _isVisible_final = true;
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_doc) {
      _isVisible_step_all = false;
      _isVisible_final = true;
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_ca) {
      _isVisible_step_all = false;
      _isVisible_final = true;
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_cs) {
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_ea) {
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_free) {
      return true;
    } else if (list_click_index == rec_month_se__from_com_as_other) {
      return true;
    } else if (list_click_index == own_busines_for_bus_mort) {
      return true;
    } else if (list_click_index == own_busines_for_bus_not_mort) {
      return true;
    } else if (list_click_index == own_busines_cust_fot_them) {
      return true;
    } else if (list_click_index == own_businesas_doc) {
      return true;
    } else if (list_click_index == own_businesas_ca) {
      return true;
    } else if (list_click_index == own_businesas_cs) {
      return true;
    } else if (list_click_index == own_businesas_ea) {
      return true;
    } else if (list_click_index == own_businesas_free) {
      return true;
    } else if (list_click_index == own_businesas_other) {
      return true;
    } else
    if (list_click_index == as_doc) {
      return true;
    } else
    if (list_click_index == as_ca) {
      return true;
    } else
    if (list_click_index == as_cs) {
      return true;
    } else
    if (list_click_index == as_ea) {
      return true;
    } else if (list_click_index == as_free) {
      return true;
    } else
    if (list_click_index == as_other) {
      return true;
    } else{
      return false;
    }
